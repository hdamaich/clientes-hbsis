...
var ClienteService = (function () {
    ...
    ClienteService.prototype.cadastra = function (cliente) {
        if (cliente.ID) {
            return this.http
                .put(this.url + '/' + cliente.ID, JSON.stringify(cliente), { headers: this.headers })
                .map(function () { return new MensagemCadastro('Cliente alterado com sucesso', false); });
        }
        else {
            return this.http
                .post(this.url, JSON.stringify(cliente), { headers: this.headers })
                .map(function () { return new MensagemCadastro('Cliente incluído com sucesso', true); });
        }
    };
    ...
    ClienteService.prototype.remove = function (cliente) {
        return this.http.delete(this.url + '/' + cliente.ID);
    };
    ClienteService.prototype.buscaPorId = function (id) {
        return this.http
            .get(this.url + '/' + id)
            .map(function (res) { return res.json(); });
    };
